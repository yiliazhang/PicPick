...
-(void)updateWithImages:(NSMutableArray *)images srcImages:(NSMutableArray *)srcImages oneImageWidth:(CGFloat)oneImageWidth oneImageHeight:(CGFloat)oneImageHeight
{
    ...
    if (images.count == 1) {
        ...
        if ([img isKindOfClass:[UIImage class]]) {
            ...
            [_oneImageView setImageWithURL:[NSURL URLWithString:[images objectAtIndex:0]]];
        }
            ...
            if (images.count == 4) {
                if (i == 0 || i == 1 ) {
                    ...
                    if ([img isKindOfClass:[UIImage class]]) {
                        ...
                        [imageUnitView.imageView setImageWithURL:[NSURL URLWithString:[images objectAtIndex:i]]];
                    }
                    ...
                    if ([img isKindOfClass:[UIImage class]]) {
                        ...
                        [imageUnitView.imageView setImageWithURL:[NSURL URLWithString:[images objectAtIndex:i-1]]];
                    }
